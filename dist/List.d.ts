...
export declare const cssProps: import("@cssfn/css-config").Refs<{
    ...
    breadcrumbSeparatorImgBlock: string;
    breadcrumbSeparatorInlineSize: string;
    breadcrumbSeparatorBlockSize: string;
    breadcrumbSeparatorInlineSizeBlock: string;
    breadcrumbSeparatorBlockSizeBlock: string;
    breadcrumbSeparatorMarginInline: string;
    breadcrumbSeparatorMarginBlock: number;
    breadcrumbSeparatorMarginInlineBlock: number;
    breadcrumbSeparatorMarginBlockBlock: string;
